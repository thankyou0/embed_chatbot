        ...
        >
          ...
          <div className="relative px-8 py-16 lg:px-16 lg:py-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/signup"
                className="group inline-flex items-center gap-2 px-8 py-4 bg-white text-emerald-700 font-semibold rounded-xl hover:bg-white/90 transition-all shadow-xl"
              >
                Get Started Free
